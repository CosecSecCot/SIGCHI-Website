...
import SectionHeading from "@/app/members/secton-heading";
...
const officers = [
    ...
    },
    {
        name: "Beas Bishnu",
        position: "Secretary",
        image: "/images/members/member9.png",
    },
    {
...
const coreTeam = [
    ...
    },
    {
        ...
        position: "Webmaster",
        image: "/images/members/member10.png",
    },
    {
        name: "Aditya Padma",
        position: "Mentor",
        ...
        <main>
            <article className="mx-[31px] sm:mx-[81px]">
                <section className="mt-[48px] sm:mt-[102px]">
                    ...
                    <div className="w-full flex justify-start">
                        <div className="mt-[64px] flex flex-wrap gap-[60px] justify-center lg:justify-start">
                            {officers.map(({ name, position, image }, idx) => (
                                <MemberCard
                                    key={idx}
                                    image={image}
                                    name={name}
                ...
                <section className="mt-[63px]">
                    ...
                    <div className="w-full flex justify-start">
                        <div className="mt-[64px] flex flex-wrap gap-[60px] justify-center lg:justify-start">
                            {coreTeam.map(({ name, position, image }, idx) => (
                                <MemberCard
                                    key={idx}
                                    image={image}
                                    name={name}
